...
def main():
    ...
    if model_name.startswith('cifar_resnet20_v1'):
    ...
    net_teacher = get_model('cifar_resnet110_v1', classes=10, pretrained=True)
    ...
    def train(epochs, ctx):
        ...
        for epoch in range(epochs):
            ...
            train_history.update([1-val_acc_teacher, 1-val_acc])
