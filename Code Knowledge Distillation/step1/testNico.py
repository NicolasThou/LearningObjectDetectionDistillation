...
box_ids, scores, bboxes, box_pred, cls_pred = net(x)
print(bboxes)
print(scores)
print()
print(box_pred)
...
plt.show()
net2 = model_zoo.get_model('faster_rcnn_resnet50_v1d_voc', pretrained=True)

start = time.time()
""" =================== PREDICTION OF STUDENT ================= """
box_ids2, scores2, bboxes2, _, _ = net2(x)
end = time.time()
...
print("nombre de classes : ", net.classes)
